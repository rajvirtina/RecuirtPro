 ...
 */
router.post('/generate/:interviewId', auth_1.protect, (0, auth_1.authorize)(types_1.UserRole.EMPLOYER, types_1.UserRole.HR, types_1.UserRole.ADMIN), scheduleController.generateSelfScheduleLink);
