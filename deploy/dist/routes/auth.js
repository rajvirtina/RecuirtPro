 ...
 *               role:
 *                 type: string
 *                 enum: [candidate, hr, interviewer, employer, admin]
 *               phoneNumber:
 *                 type: string
 *     responses:
 *       201:
...
router.post('/register', rateLimiter_1.authLimiter, [
    ...
    (0, express_validator_1.body)('role').optional().isIn(['candidate', 'hr', 'interviewer', 'employer', 'admin']),
    (0, express_validator_1.body)('phoneNumber').optional().isMobilePhone('any'),
    (0, express_validator_1.body)('companySlug').optional().trim().toLowerCase(),
 ...
 */
router.post('/logout', auth_1.protect, authController.logout);
/**
 * @swagger
 * /api/v1/auth/me:
 *   get:
 ...
 */
router.post('/refresh', [(0, express_validator_1.body)('refreshToken').notEmpty().withMessage('Refresh token is required')], authController.refresh);
/**
 * @swagger
 ...
 */
router.post('/verify-email', [(0, express_validator_1.body)('token').notEmpty().withMessage('Verification token is required')], authController.verifyEmail);
/**
 * @swagger
 ...
 */
router.post('/forgot-password', rateLimiter_1.authLimiter, [(0, express_validator_1.body)('email').isEmail().normalizeEmail().withMessage('Please provide a valid email')], authController.forgotPassword);
/**
 * @swagger
 ...
 */
router.post('/change-password', auth_1.protect, [
